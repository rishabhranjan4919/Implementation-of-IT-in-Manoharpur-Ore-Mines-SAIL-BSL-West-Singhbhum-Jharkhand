...
<body>
    ...
    <br /><br /><br />    
    <!-- table start -->
    <table class="table table-bordered" style="margin-left: 2%; margin-right: 2%; margin-top: 2%; width: 96%;">    
        <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col">NAME</th>
                <th scope="col">WORK ORDER NUMBER</th>                           
                <th scope="col">EMPLOYEE AADHAR NUMBER</th>
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM contractor ORDER BY ContractorName ASC";
            $ret = $mysql->query($sql);
